...
describe("Testing app component's State />", () => {
  ...
  it('check if default value ofdisplayDrawer in state is false', () => {
    expect(wrapper.state('displayDrawer')).toBe(true);
  });

  it('Verify that after calling handleDesplayDrawer, the state displayDrawer shoulldnoe be true', () => {
